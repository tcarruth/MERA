...
#temp<-StochasticSRA_MSC(OM,CAA,Chist,Ind,ML,CAL,mulen,wts=c(1,1,0.5,0.1,1),Jump_fac=1,nits=1000, burnin=200,thin=10,ESS=300,MLsd=0.1,ploty=F,nplot=6,SRAdir=NA,shiny=F)